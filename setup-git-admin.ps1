# Otaku Ghor - GitHub Setup Script (PowerShell) - Repository: Admin
Write-Host "🚀 Otaku Ghor - GitHub Setup Script (Repository: Admin)" -ForegroundColor Cyan
...
try {
    ...
    # Add remote repository (Repository name: Admin)
    Write-Host "🔗 Adding GitHub remote repository (Admin)..." -ForegroundColor Blue
    ...
    Write-Host ""
    Write-Host "📊 Admin Panel Access:" -ForegroundColor Magenta
    Write-Host "Username: 01944281278" -ForegroundColor White
    Write-Host "Password: fahim007" -ForegroundColor White
    Write-Host "Admin URL: http://localhost:3000/admin/login" -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "3. Connect your GitHub repository: darksodere/Admin" -ForegroundColor White
